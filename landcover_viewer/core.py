...
class LandCoverViewer():
    ...
    # land-use map
    LADNCOVER = ee.ImageCollection("projects/servir-mekong/Assemblage/RegionalLC")
    ...
    def landcover(self, year = None):
        ...
        image = ee.Image(LandCoverViewer.LADNCOVER.filterDate("%s-01-01" % year,
                                                              "%s-12-31" % year).mean())
