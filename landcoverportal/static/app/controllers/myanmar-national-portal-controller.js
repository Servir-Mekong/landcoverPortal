(function () {
    ...
    .controller('myanmarNationalPortalController', function ($rootScope, $http, $scope, $sanitize, $timeout, appSettings, CommonService, MapService, LandCoverService) {
        ...
        $rootScope.$broadcast('showLogoToggleIcon', { show: false });
        ...
        $rootScope.$broadcast('changeApplicationName', {
            application: {
                name: 'Myanmar National LC',
